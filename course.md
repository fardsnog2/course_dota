...
![Смотретиль](images/termin/наблюдатель.webp){style="display: block; margin: 0 auto"}   
...
-  <a id="aegis"></a> **_Аегис_** - Предмет выпадающий при убийстве рошана. при поднятии его, он будет находиться в инвентаре героя 5 минут или пока не убьют героя. Простым языком аегис дает вторую жизнь. ![Аегис](images/termin/аегис.jpg){width="300" height="300" style="display: block; margin: 0 auto"}   
...
-  <a id="avanpost"></a> **_Аванпост_** -  Объект на карте, по одному для каждой команды, который позволяет [телепоортироватсья](#teleport) на него. Так же при сносе [вышки](#tower) врага второго уровня(Т2) дается возможность захватывать аванпост врага.![Аванпост](images/termin/аванпост.webp){style="display: block; margin: 0 auto"}   
-  <a id="fontan"></a> **_Фонтан_** - Место возрождения героев, дает им восстановление здоровья и маны. На ней имеется лавка для покупки [предметов](#items) а так же если зайдешь на фонтант врага он начнет тебя бить.![Фонтан](images/termin/фонтаны.webp){style="display: block; margin: 0 auto"}   
...
![курьер](images/termin/курьер.webp){style="display: block; margin: 0 auto"}   
...
-  <a id="lines"></a> **_Линия_** - Это одно из трех направлений по которым бегут [крипы](#crips). У каждой линии есть свое название.![Линия](images/termin/линии%20тройка.png){style="display: block; margin: 0 auto"}   
-  <a id="neutral"></a> **_Нейтралы_** - Это те же [крипы](#crips), что бегут по [линиям](#lines), но распологаются они в [лесу](#jungle) и не имеют отношению ни к одной из сторон. Каждую минуту появляются новые при убийстве всего [кэмпа](#camp). При убийстве так же получает золото и опыт как с обычных [крипов](#crips), а так же падают [осколки](#bezumrudy) для создания [нейтральных предметов](#neutral_item) ![Крипы](images/termin/нейтралы.jpg){style="display: block; margin: 0 auto"}   
-  <a id="camp"></a> **_Кэмп_** - Область в [лесу](#jungle) где возраждаются [нейтралы](#neutral)  
![Кэмп](images/termin/кэмп.webp){width="800" height="600"style="display: block; margin: 0 auto"}  
-  <a id="neutral_item"></a> **_Нейтралка_** -  Это [вещи](#items) которые создаются из [осколков](#bezumrudy) выпадающих из [нейтралов](#neutral). Есть 5 уровней [вещей](#items) которые создаются постепенно по ходу игры. ![Нейтралка](images/termin/нейтралки.png){style="display: block; margin: 0 auto"}   
-  <a id="lotus"></a> **_Лотус_** - На боковых [линиях](#lines) распологаются пруды в которых раз в 3 минуты появляюся лотусы которые восстанавливают мгновенно здоровье и ману. Лотусы можно собирать они не ограничены по времени жизни.  ![Лотус](images/termin/лотус.jpg){style="display: block; margin: 0 auto"}   
-  <a id="wards"></a> **_Варды_** -  [Предмет](#items) который покупается в лавке. их нужно ставить на карте, куда ставить решает сам человек, но важно что ставить так чтобы они давали максимально возможную информацию, есть два вида вардов:
    ...
    ![Варды](images/termin/варды.jpg){style="display: block; margin: 0 auto"}   
...
![Смоки](images/termin/смок.jpg){width="400" height="400" style="display: block; margin: 0 auto"} 
-  <a id="anshent"></a> **_Эншенты_** -  Это [нейтралы](#neutral), но более сильные. ![Эншы](images/termin/эншент%20стаки.jpg){style="display: block; margin: 0 auto"}   
...
-  <a id="runes"></a> **_Руна_** -  Объект на карте, всего 4 места их расположения, по два в каждом из [лесу](#jungle) и 2 на [реке](#river). В [лесу](#jungle) всегда появлются руны богатства, дающии золото всей команде. На [реке](#river) же первые 4 минуты появляются руны воды, это аналогично [лотусам](#lotus) но применение идет сразу после того как подобрали. На 6 и потом каждые 2 минуты появляется одна из следующих рун:
    ...
    ![Руны](images/termin/руны.webp){width="600" height="300"style="display: block; margin: 0 auto"}   
...
![Мудрость](images/termin/мудрость.webp){style="display: block; margin: 0 auto"}   
...
-  <a id="tower"></a> **_Башня/Вышка/Тавер_** -  Сооружение на каждой из [линий](#lines) у обеих команд. Всего команд по 3 вышки на каждой из [линий](#lines), а так же по две вышки у [трона](#tron). Обычно говорят не вышка или тавер а Т1,T2,T3,T4
    ...
    ![Башня](images/termin/башня.webp){width="600" height="400" style="display: block; margin: 0 auto"}   
...
-  <a id="barrack"></a> **_Казармы/барак_** -  Сооружения находящиеся на каждой из [линий](#lines) на базе, есть казарма для [крипов](#crips) дальнего боя и для ближнего,  при разрушении казарм, команда сделавшая это получает усиление [крипов](#crips) на этой [линии](#lines) и на того типа, чей барак был разрушен ![Казармы](images/termin/казармы.jpg){style="display: block; margin: 0 auto"}   
...
![аганим](images/termin/аганим.png){width="400" height="400" style="display: block; margin: 0 auto"}   
-  <a id="shard"></a> **_Шард_** -  То же самое что [аганим](#aganim) только менее силен чаще всего. Улучшения есть у каждого героя ![Шард](images/termin/аганим%20шард.jpg){style="display: block; margin: 0 auto"}  
-  <a id="talant"></a> **_Таланты_** -  На 10/15/20/25 уровнях, герои имеют возможность выбрать одно из 2 улучшений для себя, всего 8 талантов, начиная с 27 уровня можно выбрать второй талант на каждом уровне градации талантов  ![таланты](images/termin/ланты.webp){style="display: block; margin: 0 auto"}  
-  <a id="aspekt"></a> **_Аспект_** - При выборе героя, можно выбрать один из двух(иногда есть по 3 и более аспектов) вариантов твоего героя, чаще всего имеет какие-то [бафы](#baff) для героя. ![Аспект](images/termin/аспекты.webp){style="display: block; margin: 0 auto"}  
-  <a id="vrozh_sposob"></a> **_Врожденная способность_** -  [Способность](#skills) которая есть у героя всегда, вне зависимоости от уровня и она одна и та же от игры к игре ![Врожденная способность](images/termin/врожденная%20способноость.png){style="display: block; margin: 0 auto"}  
...
-  <a id="third"></a> **_Тройка_** - Область на карте, возле [потайной лавки](#market) (была названа так как там было 3 [кемпа](#camp), сейчас там их 2)![река](images/termin/линии%20тройка.png){style="display: block; margin: 0 auto"}  
-  <a id="jungle"></a> **_Лес_** - Область на карте между [линиями](#lines) 
![Лес](images/termin/линии%20тройка.png){style="display: block; margin: 0 auto"}  
-  <a id="otvod"></a> **_Отвод_** - Для того чтобы "сломать" [линию](#lines) для врага и сделать ее более удобнеой для [керри](#carry), [саппорты](#support) чаще всего отводят лайновых [крипов](#crips) на [нейтралов](#neutral){style="display: block; margin: 0 auto"}
-  <a id="stack"></a> **_Стак_** - Лесных [крипов](#crips) на [кемпе](#camp) можно увеличивать, если успеть вывести [крипов](#crips) из зоны возраждения в момент, когда они должны появиться, то появятся новые а старые останутся ![Стак](images/termin/эншент%20стаки.jpg){style="display: block; margin: 0 auto"}  
...
-  <a id="dust"></a> **_Дасты_** - [Предмет](#skills) который при использовании его в радиусе действия накладывает на всех существ [деббафф](#debaff) который раскрывает невидимость  ![Дасты](images/termin/дасты.jpg){width="600" height="400" style="display: block; margin: 0 auto"}  
-  <a id="banner"></a> **_Баннер_** - [Предмет](#items) выпадающий с [рошана](#roshan), он дает [глиф](#glif) на [крипов](#crips) в радиусе действия ![баннер](images/termin/баннер.jpg){style="display: block; margin: 0 auto"}  
...
-  <a id="tron"></a> **_Трон_** - Самое главное здание у каждой из команд в случае его разрушения команда проигрывает ![трон](images/termin/трон.webp){style="display: block; margin: 0 auto"}  
-  <a id="market"></a> **_Потайная лавка_** - Второй магазин в котором можно купить более дорогие и важные [предметы](#items)  ![потайная](images/termin/потайная%20лавка.jpg) 
